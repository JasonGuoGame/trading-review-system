...
func Setup(handlers *handler.Handlers, mw *middleware.Middleware) *gin.Engine {
	...
	api := r.Group("/api")
	{
		...
		api.GET("/market-breadth/rising-sectors", handlers.MarketBreadth.GetTopRisingSectors)
		api.GET("/market-breadth/snapshot-times", handlers.MarketBreadth.GetSnapshotTimes)
	...
	sectorSentiment := api.Group("/sector-sentiment")
	{
		...
		sectorSentiment.GET("/top-sectors", handlers.SectorSentiment.GetTopSectors)
		sectorSentiment.GET("/top-rising", handlers.SectorSentiment.GetTopRising)
		sectorSentiment.GET("/top-falling", handlers.SectorSentiment.GetTopFalling)
